...
// @history        1.0 = Complete rewrite of the code to allow custom rules / actions; 100319.2008 = It is working when used via the Firebug console but not as a greasemonkey script (Error console states 'component not available' with no indication re:line numbers or to which component it refers to =/ ; 
// @history        1.0 = Complete rewrite of the code to allow custom rules / actions; 100319.2113 = After some googling I changed to jQuery 1.3.2 (from what I assume was 1.4) and the problems ceased, almost ready to release;
  ...
  $('tr[onmouseout]').each(function(i,currentReferral) {
    ...
    $(preferences.rules.specific).each(function(x,currentRule) {
      ...
      if(ref_OverallAvg < rules_maxAvg) 
      {
        ...
        if('undefined' !== typeof currentRule.action.opacity)
        {
          currentReferral.style.opacity = currentRule.action.opacity;
        }
      }
